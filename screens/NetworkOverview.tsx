...
export const NetworkOverview = () => {
  return (
    <div className="grid grid-cols-12 h-full gap-px bg-rail-border/50">
      {/* Left Sidebar: Incidents */}
      <div className="col-span-3 bg-rail-dark/80 backdrop-blur-sm flex flex-col border-r border-rail-border/50">
        <div className="p-4 border-b border-rail-border/50 flex justify-between items-center bg-rail-panel/60 backdrop-blur-sm">
             ...
             <div key={i} className={`p-3 rounded-xl backdrop-blur-sm border-l-2 transition-all duration-200 cursor-pointer group ${
               inc.priority === 'P1'
                 ...
                 : inc.priority === 'P3'
                   ...
                   : 'bg-rail-panel/60 border-rail-primary hover:bg-rail-panel/80 hover:shadow-[0_0_15px_rgba(37,192,244,0.1)]'
             }`}>
                ...
                <h4 className="text-sm font-medium text-white leading-tight mb-1 group-hover:text-rail-primary transition-colors">{inc.title}</h4>
        ...
        <div className="p-4 border-t border-rail-border/50 bg-rail-panel/40 backdrop-blur-sm">
      ...
      <div className="col-span-6 bg-[#050910] relative overflow-hidden group">
         ...
         <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/90 to-transparent">
            <div className="glass rounded-xl p-3 flex items-center gap-4 border border-rail-border/50 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
               <button className="size-9 rounded-full bg-gradient-to-br from-rail-primary to-[#1a9cc9] text-black flex items-center justify-center hover:scale-105 transition shadow-[0_0_15px_rgba(37,192,244,0.4)]">
                 <span className="material-symbols-outlined">play_arrow</span>
               </button>
               <div className="flex-1 relative h-1.5 bg-white/10 rounded-full backdrop-blur-sm">
                  <div className="absolute left-0 top-0 bottom-0 w-[85%] bg-gradient-to-r from-rail-primary to-[#1a9cc9] rounded-full shadow-[0_0_8px_rgba(37,192,244,0.5)]"></div>
                  <div className="absolute left-[85%] top-1/2 -translate-y-1/2 size-4 bg-white rounded-full shadow-[0_0_12px_white] ring-2 ring-rail-primary/30"></div>
               </div>
      ...
      {/* Right: Stats */}
      <div className="col-span-3 bg-rail-dark/80 backdrop-blur-sm border-l border-rail-border/50 flex flex-col p-4 gap-4">
                 ...
                 {[{n:'Union Station', v:92, c:'rail-danger'}, {n:'West Term', v:85, c:'rail-warning'}, {n:'North Gate', v:45, c:'rail-success'}].map((st, i) => (
                    <div key={i} className="group">
                       <div className="flex justify-between text-xs mb-1">
                          <span className="text-white group-hover:text-rail-primary transition-colors">{st.n}</span>
